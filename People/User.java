...
import Comparators.PaperDatePublishComparator;
import Comparators.PaperPageComparator;
...
public class User {
    ...
    public boolean getIsResearcher() {
        return false; // Пользователь по умолчанию не является исследователем
    }
